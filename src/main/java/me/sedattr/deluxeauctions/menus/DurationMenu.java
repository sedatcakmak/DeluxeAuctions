    ...
    private void loadDurationItems() {
        ...
        for (String key : durationsSection.getKeys(false)) {
            ...
            PlaceholderUtil placeholderUtil = new PlaceholderUtil()
                    .addPlaceholder("%duration_fee%", this.playerAuction.getCreateEconomy().getText().replace("%price%", DeluxeAuctions.getInstance().numberFormat.format(AuctionHook.calculateDurationFee(time, this.playerAuction.getCreateEconomy(), this.playerAuction.getCreatePrice()))));
